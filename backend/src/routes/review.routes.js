...
function buildReview(submission) {
  ...
  return {
    ...
    overallScore,
    timeComplexity: "Estimated from static analysis: review manually for precision.",
    spaceComplexity: "Estimated from static analysis: review manually for precision.",
